      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="hidden md:flex font-weird items-center">
          ...
          <div className="text-[10px] sm:text-[11px] lg:text-[12px] xl:text-[13px]">
            <Link to={getLanguageLink('EN')} className="hover:text-gray-600 transition-colors">EN</Link>
            <span className="mx-1"> | </span>
            <Link to={getLanguageLink('TH')} className="hover:text-gray-600 transition-colors">TH</Link>
          </div>        
        </div>
      </div>
